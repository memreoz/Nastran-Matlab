...
BASE_DIR  = 'D:\Document\VSCL\MATLAB_NASTRAN\';
BDF_IN    = fullfile(BASE_DIR, 'OHC_VS_PATCH_SET_MATLAB.bdf');
BDF_OUT   = fullfile(BASE_DIR, 'OHC_VS_PATCH_SET_MATLAB_V3.bdf');
...
ec(end+1).elem_id = 5;   ec(end).angles = [45,  -45,  0  ];
ec(end+1).elem_id = 23;  ec(end).angles = [0,    45, -45  ];
ec(end+1).elem_id = 50;  ec(end).angles = [30,  -30,  90  ];
ec(end+1).elem_id = 45;  ec(end).angles = [30,  -9,  90  ];
ec(end+1).elem_id = 3;  ec(end).angles = [30,  -30,  90  ];
ec(end+1).elem_id = 54;  ec(end).angles = [30,  -30,  90  ];
ec(end+1).elem_id = 99;  ec(end).angles = [30,  -8,  0  ];
ec(end+1).elem_id = 76;  ec(end).angles = [30,  -6,  90  ];
%% ===== OPSIYONLAR =======================================================
